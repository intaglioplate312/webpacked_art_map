...
INSERT INTO `art` (`id`, `title`, `artist`, `media`, `description`,`type`, `viewable`, `img_file_path`, `geolat`, `geolng`, `google_geo`, `street_number`, `route`, `city`, `state`, `zip`, `user_id`, `date`)
VALUES
